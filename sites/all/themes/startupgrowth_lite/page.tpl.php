            ...
            <div id="header-inside" class="clearfix">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div id="header-inside-right" class="clearfix">
<div id="main-navigation" class="clearfix <?php if ($page['search_area']) { ?> with-search-bar <?php } ?>">
                            <ul class="social-bookmarks text-right header-social-bookmarks">
<li class="text">
...
<a href="http://instagram.com/"><i class="fa fa-instagram"></i></a>
    ...
    <footer id="footer" class="clearfix">
        <div class="container">
            ...
            <div class="row"><p><a href="<?php echo $base_url; ?>/modal_forms/nojs/contact/Website-feedback" class="more get-in-touch ctools-use-modal">Get in touch</a></p></div>
        </div>
    </footer> 
    <!-- EOF #footer -->
    <?php endif; ?>
